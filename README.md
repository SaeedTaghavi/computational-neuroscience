...
این کتاب در حال توسعه است و بازخورد شما به بهتر شدن آن کمک می‌کند. برای پیشنهاد فصل یا بخش جدید، گزارش اشکال، یا هر پیشنهاد دیگری، یک [ایشو در گیت‌هاب](https://github.com/SaeedTaghavi/computational-neuroscience/issues) باز کنید.
