...
!!! info "پیشرفته (اختیاری)"
    این بخش برای سامانه‌های انرژی‌پایسته (هامیلتونی) اهمیت دارد و برای ادامهٔ مطالبِ نورونیِ کتاب ضروری نیست؛ اما برای کسانی که با سامانه‌های نوسانیِ بلندمدت کار می‌کنند بسیار سودمند است.
