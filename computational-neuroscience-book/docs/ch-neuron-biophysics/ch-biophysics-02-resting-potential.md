...
!!! example "تمرین‌ها"
    ...
    ۷. **(پروژه)** پتانسیلِ استراحت را بر حسبِ **دو** پارامترِ \(P_{\text{Na}}/P_{\text{K}}\) و \([\text{K}^+]_{\text{out}}\) به‌صورتِ یک نقشهٔ رنگی رسم کنید و نواحیِ «قطبیده» و «دپلاریزه» را مشخص کنید.
